...
//function fun_one(arg2:string,arg3?:string,arg1?:string):void{}
//[Note : combination of normal with optional, optional always should be last]
//[Note : we can have more than "one option argument"]


function fun_one(arg1:string,arg2?:string,...arg3:string[]):void{}
//@param1 --- normal        @param2  --- optional      @param3 --- rest
