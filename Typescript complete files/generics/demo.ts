...
let obj1 = new class_one<string,string>("Hello","Hi");
console.log( obj1.arg1, obj1.arg2 );   //Hello Hi

let obj2 = new class_one<number,number>(100,100);
console.log( obj2.arg1, obj2.arg2 );   //100 100

let obj3 = new class_one<any,any>("Hello",true);
console.log( obj3.arg1,obj3.arg2 );    //Hello true
*/

//combination of interfaces , JSON , and generic functions
...
//pass the obj to fun_one with Generic
function fun_one<G extends interface2>(arg1:G){
    console.log( arg1.var_one, arg1.var_two );
};
fun_one(obj);    //Hello  Welcome
